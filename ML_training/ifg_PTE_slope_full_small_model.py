...
dump(scaler_x, 'Scaler/ifg_PTE_slope_full_small_model_MinMax_scaler_x.bin', compress=True)
dump(scaler_y, 'Scaler/ifg_PTE_slope_full_small_model_MinMax_scaler_y.bin', compress=True)
...
plt.savefig('Plots/Small_batch_32/ifg_PTE_full_small_model_MSE_history.png', dpi=300)
plt.clf()
...
plt.xlabel('No. epoch')
plt.legend(loc="upper left")
plt.savefig('Plots/Small_batch_32/ifg_PTE_full_small_model_MAE_history.png', dpi=300)

# Saving model
model.save('Model/ifg_PTE_full_small_model')
...
fig.savefig('Plots/Small_batch_32/ifg_PTE_slope_full_small_model_Ob_v_Pred.png', dpi=300)
...
cbar.ax.tick_params(labelsize=10)
fig.savefig('Plots/Small_batch_32/ifg_PTE_slope_full_small_model_Resid_true.png', dpi=300)
