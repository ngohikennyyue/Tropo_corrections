...
x_train, scaler_x = standardized(x_train, 'Standard')
...
plt.savefig('Plots/SAC_Standard_MSE_history.png', dpi=300)
plt.clf()
...
plt.xlabel('No. epoch')
plt.legend(loc="upper left")
plt.savefig('Plots/SAC_Standard_MAE_history.png', dpi=300)
plt.clf()
...
fig.savefig('Plots/SAC_Standard_Ob_v_Pred.png', dpi=300)
plt.clf()
...
cbar.ax.tick_params(labelsize=10)
fig.savefig('Plots/SAC_Standard_Resid_true.png', dpi=300)
plt.clf()
