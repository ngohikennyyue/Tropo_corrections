...
trainA, testA, pteScaler = process_PTE_data(train, test, ('Lat', 'Hgt_m', 'P_', 'T_', 'e_'))
trainB, testB, cmiScaler = process_PTE_data(train, test, ('Lat', 'Hgt_m', 'CMI_C'))
# cs = MinMaxScaler()
...
dump(pteScaler, 'Scaler/Test_New_model2_MIML_pteScaler_x.bin', compress=True)
dump(cmiScaler, 'Scaler/Test_New_model2_MIML_cmiScaler_x.bin', compress=True)
dump(cs, 'Scaler/Test_New_model2_MIML_scaler_y.bin', compress=True)
...
plot_model(model, 'Plots/Test_New_model2_ZTD_pred_model.png', show_shapes=True)
...
plt.savefig('Plots/Test_New_model2_MSE_history.png', dpi=300)
plt.clf()
...
# Saving model
model.save('Model/Test_New_model2_US_WE_PTE_fixed_hgtlvs_cloud_model')
...
fig.savefig('Plots/Test_New_model2_Ob_v_Pred.png', dpi=300)
...
cbar.ax.tick_params(labelsize=10)
fig.savefig('Plots/Test_New_model2_Resid_true.png', dpi=300)
