...
plt.savefig('Plots/Interp_MSE_history.png', dpi=300)
plt.clf()
...
plt.xlabel('No. epoch')
plt.legend(loc="upper left")
plt.savefig('Plots/Interp_MAE_history.png', dpi=300)
plt.clf()
...
fig.savefig('Plots/Interp_Ob_v_Pred.png', dpi=300)
...
cbar.ax.tick_params(labelsize=10)
fig.savefig('Plots/Interp_Resid_true.png', dpi=300)
