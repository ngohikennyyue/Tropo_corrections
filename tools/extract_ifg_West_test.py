...
extract_ifg_param(ifg_path='Extracted/unwrappedPhase/', wm_file_path='weather_files/',
                  ...
                  slope_path='slope.tif', coh_path='Extracted/coherence/', time='T01_50_00', years=[2021],
                  lon_min=-118.5, lat_min=32.2, lon_max=-117.5, lat_max=41.2, inter=False, samp=500, name='test')
