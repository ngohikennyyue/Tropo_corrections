...
extract_ifg_param(ifg_path='Extracted/unwrappedPhase/', wm_file_path='weather_files/',
                  ...
                  slope_path='slope.tif', coh_path='Extracted/coherence/', time='T23_05_00', years=[2019, 2020],
                  lon_min=-78, lat_min=34.2, lon_max=-77, lat_max=45.2, inter=False, samp=250, name='train')
